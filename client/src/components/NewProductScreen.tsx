      ...
      <div className="flex-1 flex justify-center p-8">
        <div className="w-full max-w-5xl flex gap-12">
          <div className="flex-1 space-y-6 pb-20">
            ...
            <section id="product-options" className="bg-white overflow-hidden">
               <div className="p-8 space-y-6">
                  <div>
                  ...
                  <div className="pt-6 space-y-8">
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                          <label className="block text-[11px] font-medium text-gray-400 uppercase tracking-widest mb-3">Colors</label>
                          <div className="flex flex-wrap gap-1.5">
                            {COLORS.slice(0, 5).map(color => (
                              <button 
                                key={color}
                                onClick={() => toggleSelection(color, selectedColors, setSelectedColors)}
                                className={`px-3 py-1.5 rounded-lg text-[11px] font-normal transition-all border
                        ...
                        <div>
                           <label className="block text-[11px] font-medium text-gray-400 uppercase tracking-widest mb-3">RAM Size</label>
                           <div className="flex flex-wrap gap-1.5">
                              {RAM_OPTIONS.map(ram => (
                                <button 
                                  key={ram}
                        ...
                        <div>
                           <label className="block text-[11px] font-medium text-gray-400 uppercase tracking-widest mb-3">Storage</label>
                           <div className="flex flex-wrap gap-1.5">
